...
const DailyPayment = ({ patientId }) => {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === "paymentDate") {
      ...
      //   console.log(`patient with id-${patientId} has already paid on ${todayDate}`)
      // }else{
      //   console.log(`patient with id-${patientId} has not paid on ${todayDate}`)
      // }
    }
  };
  ...
  return (
    <div className="rounded-xl px-8 pt-6 pb-4 mb-4 border-2 border-gray-300  flex">
      <div className=" w-1/2 center flex-col relative pb-8">
              ...
              <div className=" w-full">
                ...
                <div className="flex items-center justify-end">
                  <button
                    ...
                    disabled={isLoading || isAlreadyPaidToday || loadingPatient}
        ...
        {isAlreadyPaidToday && (
          <div className="absolute bottom-0 text-green-700 font-medium">
            Payment done on {formatDate(todayDate)}
          </div>
        )}
      </div>
      {showPrintCard && (
