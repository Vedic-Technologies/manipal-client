            ...
            <div className="md:flex">
              ...
              <div className="w-1/2 p-5 ">
                <div className="text-center">
                  <h2 className=" text-zinc-900 text-4xl font-bold mt-10" style={{fontFamily:"Edu VIC WA NT Beginner"}}>Sign In</h2>
                </div>
                ...
                <form className="space-y-6 mt-20  w-[70%]">
                  <div>
                    ...
                    <input type="email" name="email" id="email" placeholder="demo@example.com" className="w-full px-3 py-2 border border-zinc-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required />
                  </div>
                  <div>
