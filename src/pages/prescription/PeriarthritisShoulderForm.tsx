...
//   };
  ...
  return (
    <div className='bg-red-300 w-screen4/5'>
         <form className="p-4 bg-gray-100 rounded shadow-md max-w-full mx-auto mt-10">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              selectedShoulder === 'right' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Right
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              selectedShoulder === 'left' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Left
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              natureOfPain === 'continuous' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Continuous
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              natureOfPain === 'onActivity' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            On Activity
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              symptoms === 'improving' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Improving
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              symptoms === 'worsening' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Worsening
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              symptoms === 'remainSame' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Remain Same
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              onset === 'gradual' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Gradual
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              onset === 'sudden' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Sudden
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              injury === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Yes
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              injury === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            No
          </button>
        ...
        <div className="mt-1 grid grid-cols-4 gap-2">
          {['fall', 'RTA', 'throwing', 'lifting'].map((type) => (
            <button
              ...
              className={`px-4 py-2 rounded-full border ${
                typeOfInjury === type ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
              }`}
            >
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              aggravatingFactor === 'movement' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              relievingFactor === 'rest' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Rest
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              relievingFactor === 'medication' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Medication
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              intensityOfPainAtNight === 'increased' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Increased
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              intensityOfPainAtNight === 'decreased' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Decreased
          </button>
      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              sleepDisturbance === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            Yes
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full border ${
              sleepDisturbance === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
            }`}
          >
            No
          </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        HTN.status === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        HTN.status === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
  ...
  {HTN.status === 'yes' && (
    <div className="mt-4 flex space-x-4">
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          HTN.medication === 'regular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
      ...
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          HTN.medication === 'irregular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
...
{/* DM2 */}
<div className="mb-4">
  <label className="block text-sm font-medium text-gray-700">DM2</label>
  <div className="mt-1 flex space-x-4">
    <button
      type="button"
      onClick={() => setDM2({ ...DM2, status: 'yes' })}
      className={`px-4 py-2 rounded-full border ${
        DM2.status === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        DM2.status === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
  ...
  {DM2.status === 'yes' && (
    <div className="mt-4 flex space-x-4">
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          DM2.medication === 'regular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        On Regular Medications
      </button>
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          DM2.medication === 'irregular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        On Irregular Medications
      </button>
...
{/* Hypothyroidism */}
<div className="mb-4">
  <label className="block text-sm font-medium text-gray-700">Hypothyroidism</label>
  <div className="mt-1 flex space-x-4">
    <button
      type="button"
      onClick={() => setHypothyroidism({ ...hypothyroidism, status: 'yes' })}
      className={`px-4 py-2 rounded-full border ${
        hypothyroidism.status === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        hypothyroidism.status === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
  ...
  {hypothyroidism.status === 'yes' && (
    <div className="mt-4 flex space-x-4">
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          hypothyroidism.medication === 'regular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        On Regular Medications
      </button>
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          hypothyroidism.medication === 'irregular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        On Irregular Medications
      </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        selectedShoulder1 === 'right' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Right
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        selectedShoulder1 === 'left' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Left
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        swelling === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        swelling === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        muscleWasting === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        muscleWasting === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
...
<div className="mb-4">
  <label className="block text-sm font-medium text-gray-700">Neurological Deficit</label>
  <div className="mt-1 flex space-x-4">
    <button
      type="button"
      onClick={() => handleToggle(setNeurologicalDeficit, 'yes')}
      className={`px-4 py-2 rounded-full border ${
        neurologicalDeficit === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        neurologicalDeficit === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
  ...
  {neurologicalDeficit === 'yes' && (
    <div className="mt-4 flex space-x-4">
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          neurologicalType === 'motor' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        Motor
      </button>
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          neurologicalType === 'sensory' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        Sensory
      </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        capsularPattern === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        capsularPattern === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        muscleTightness === 'yes' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Yes
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        muscleTightness === 'no' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      No
    </button>
  ...
  <div className="mt-1 grid grid-cols-3 gap-4">
    {['Supraspinatus', 'Infraspinatus', 'Subscapularis', 'Teres Minor', 'Deltoid', 'Pectoral'].map((muscle) => (
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          musclesName.includes(muscle) ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        {muscle}
      </button>
  ...
  <div className="mt-1 grid grid-cols-3 gap-4">
    {['Supraspinatus Tendon', 'Deltoid Insertion', 'AC Joint'].map((tendernessPoint) => (
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          tenderness.includes(tendernessPoint) ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        {tendernessPoint}
      </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        rom === 'left' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Left Shoulder
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        rom === 'right' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Right Shoulder
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        musclePower === 'fine' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      It's Fine
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        musclePower === 'decreased' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        gripPinch === 'strong' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Strong
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        gripPinch === 'weak' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Weak
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        tone === 'normal' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Normal
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        tone === 'hypertonic' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Hypertonic
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        tone === 'hypotonic' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Hypotonic
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        coordination === 'good' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Good
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        coordination === 'moderate' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Moderate
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        coordination === 'poor' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Poor
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        thumbDropTest === 'positive' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Positive
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        thumbDropTest === 'negative' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Negative
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        painfulArcTest === 'positive' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Positive
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        painfulArcTest === 'negative' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Negative
    </button>
...
<div className="mb-4">
  ...
  <div className="mt-1 flex space-x-4">
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        adl === 'dependent' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Dependent
    </button>
    <button
      ...
      className={`px-4 py-2 rounded-full border ${
        adl === 'independent' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
      }`}
    >
      Independent
    </button>
  ...
  <div className="mt-1 grid grid-cols-2 gap-4">
    {['Clothing', 'Combing', 'Lifting Objects', 'Overhead activities', 'Grip & Pinch'].map((activity) => (
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          difficulty.includes(activity) ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        {activity}
      </button>
  ...
  <div className="mt-1 grid grid-cols-2 gap-4">
    {[
      ...
      <button
        ...
        className={`px-4 py-2 rounded-full border ${
          modalities.includes(modality) ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
        }`}
      >
        {modality}
      </button>
        ...
        <div className="mt-1 grid grid-cols-2 gap-4">
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full border ${
                exercises.includes(exercise) ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border-gray-300'
              }`}
            >
              {exercise}
            </button>
